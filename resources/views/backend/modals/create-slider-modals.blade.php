<div class="modal fade" id="createSliderModal" aria-hidden="true" aria-labelledby="..." tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Portfolio Slider</h5>
                ...
                <form method="POST" action="{{ route('admin.store.slider') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="file" class="form-control @error('images') is-invalid @enderror" id="images" name="images" required>
                            <div class="invalid-feedback">
                                @error('images')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control @error('video_url') is-invalid @enderror" id="video_url" name="video_url" placeholder="Video URL" value="{{ old('video_url') }}" required>
                            <div class="invalid-feedback">
                                @error('video_url')
                                    {{ $message }}
                                @enderror
