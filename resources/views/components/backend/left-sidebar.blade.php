    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            <div style="display: flex;justify-content: center;">
                <img src="{{ Storage::url('profiles/'.Auth::user()->profile_image) }}" alt="" class="avatar-md rounded-circle">
            </div>
            <div class="mt-3">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('admin.get.slider') }}" class=" waves-effect">
                ...
                <li>
                    <a href="{{ route('admin.get.about') }}" class=" waves-effect">
